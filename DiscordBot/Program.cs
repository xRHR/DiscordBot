...
builder.Services.AddSingleton(new DiscordConfiguration { Token = Environment.GetEnvironmentVariable("DISCORD_TOKEN"), }); // Put token here
...
file sealed class ApplicationHost : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        _discordClient
            ...
            .RegisterCommands<MusicCommands>(); // Add guild id here
